 ...
 *
 * The app entry must set the locale through ./bootLocale imported BEFORE any
 * other module: catalogs call t() at module-evaluation time, which would
 * otherwise freeze the default ("en") strings.
 */
