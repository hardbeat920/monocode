...
export const en: Record<string, string> = {
  ...
  "Confirm": "Confirm",
  "Approve permissions": "Approve permissions",
  "Shell": "Shell",
  "Edit {0}": "Edit {0}",
  "Subagent": "Subagent",
  "{0} subagent": "{0} subagent",

  // model settings catalog labels
  "On": "On",
  "Off": "Off",
  "None": "None",
  "Minimal": "Minimal",
  ...
  // missed during the first translation pass
  "Could not archive this conversation.\n\n{0}": "Could not archive this conversation.\n\n{0}",
  "Could not delete this conversation.\n\n{0}": "Could not delete this conversation.\n\n{0}",
  "Could not unarchive this conversation.\n\n{0}": "Could not unarchive this conversation.\n\n{0}",
  "How can I help you today?": "How can I help you today?",
  "Diverged from {0}": "Diverged from {0}",
  "{0} result{1} in {2} file{3}": "{0} result{1} in {2} file{3}",
  "(limited)": "(limited)",
  "Skill \"{0}\" could not be read from {1}.": "Skill \"{0}\" could not be read from {1}.",
  "\"{0}\" is still running in {1}. Close this terminal anyway?": "\"{0}\" is still running in {1}. Close this terminal anyway?",

  // upstream follow-up: zoom, notifications, transcript fold summaries
  "Zoom In": "Zoom In",
  "Zoom Out": "Zoom Out",
  "Reset Zoom": "Reset Zoom",
  "View: Zoom In": "View: Zoom In",
  "View: Zoom Out": "View: Zoom Out",
  "View: Reset Zoom": "View: Reset Zoom",
  "Notifications": "Notifications",
  "Notify when an agent finishes or needs input in another session or while MonoCode is in the background. Click the notification to open that session.": "Notify when an agent finishes or needs input in another session or while MonoCode is in the background. Click the notification to open that session.",
  "Not available on this platform": "Not available on this platform",
  "Close this window and stop its running chats? Other windows will stay open.": "Close this window and stop its running chats? Other windows will stay open.",
  "Hide the work": "Hide the work",
  "Show the work": "Show the work",
  "Editing {0}": "Editing {0}",
  "Edited {0}": "Edited {0}",
  "Reading {0}": "Reading {0}",
  "Read {0}": "Read {0}",
  "Searching the project": "Searching the project",
  "Searched the project": "Searched the project",
  "Exploring the project": "Exploring the project",
  "Explored the project": "Explored the project",
  "Running a command": "Running a command",
  "Ran a command": "Ran a command",
  "Running {0} commands": "Running {0} commands",
  "Ran {0} commands": "Ran {0} commands",
  "Running a subagent": "Running a subagent",
  "Ran a subagent": "Ran a subagent",
  "Running {0} subagents": "Running {0} subagents",
  "Ran {0} subagents": "Ran {0} subagents",
  "Running a tool": "Running a tool",
  "Ran a tool": "Ran a tool",
  "Running {0} tools": "Running {0} tools",
  "Ran {0} tools": "Ran {0} tools",
  "{0} {1}…": "{0} {1}…",
  "{0} {1} for {2}": "{0} {1} for {2}",
  "{1} for {2}": "{1} for {2}",
