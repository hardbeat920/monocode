...
export const zhCN: Record<string, string> = {
  ...
  "Diverged from {0}": "已与 {0} 分叉",
  "{0} result{1} in {2} file{3}": "{0} 个结果，位于 {2} 个文件",
  "(limited)": "（已截断）",
  "Skill \"{0}\" could not be read from {1}.": "无法从 {1} 读取技能“{0}”。",
  "\"{0}\" is still running in {1}. Close this terminal anyway?": "“{0}”仍在 {1} 中运行。仍要关闭终端吗？",
  ...
  "View: Zoom In": "视图：放大",
  "View: Zoom Out": "视图：缩小",
  "View: Reset Zoom": "视图：重置缩放",
  "Notifications": "通知",
  "Notify when an agent finishes or needs input in another session or while MonoCode is in the background. Click the notification to open that session.": "当智能体在另一个会话中完成或需要输入，或 MonoCode 处于后台时发出通知。点击通知可打开对应会话。",
  "Not available on this platform": "当前平台不支持",
  "Close this window and stop its running chats? Other windows will stay open.": "关闭此窗口并停止其中正在运行的对话？其他窗口将保持打开。",
  "Hide the work": "收起工作内容",
  "Show the work": "展开工作内容",
  "Editing {0}": "正在编辑 {0}",
  "Edited {0}": "已编辑 {0}",
  "Reading {0}": "正在读取 {0}",
  "Read {0}": "已读取 {0}",
  "Searching the project": "正在搜索项目",
  "Searched the project": "已搜索项目",
  "Exploring the project": "正在探索项目",
  "Explored the project": "已探索项目",
  "Running a command": "正在运行命令",
  "Ran a command": "运行了一条命令",
  "Running {0} commands": "正在运行 {0} 条命令",
  "Ran {0} commands": "运行了 {0} 条命令",
  "Running a subagent": "正在运行子代理",
  "Ran a subagent": "运行了一个子代理",
  "Running {0} subagents": "正在运行 {0} 个子代理",
  "Ran {0} subagents": "运行了 {0} 个子代理",
  "Running a tool": "正在使用工具",
  "Ran a tool": "使用了一个工具",
  "Running {0} tools": "正在运行 {0} 个工具",
  "Ran {0} tools": "运行了 {0} 个工具",
  "{0} {1}…": "{0} {1}…",
  "{0} {1} for {2}": "{0} {1}，用时 {2}",
  "{1} for {2}": "{1}，用时 {2}",
