...
export const Braces = wrap(BracesIcon, "Braces");
...
export const Component = wrap(ComponentIcon, "Component");
export const Copy = wrap(Copy01Icon, "Copy");
export const Cube = wrap(CubeIcon, "Cube");
...
export const Function = wrap(FunctionIcon, "Function");
...
export const Hash = wrap(HashIcon, "Hash");
export const Heading = wrap(Heading01Icon, "Heading");
...
export const Paragraph = wrap(ParagraphIcon, "Paragraph");
...
export const Structure = wrap(Structure01Icon, "Structure");
...
export const Type = wrap(TypeIcon, "Type");
...
export const Variable = wrap(VariableIcon, "Variable");
