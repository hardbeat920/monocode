...
pub struct Labels {
    ...
    pub toggle_session_sidebar: &'static str,
...
pub const EN: Labels = Labels {
    ...
    toggle_session_sidebar: "Toggle Session Sidebar",
    open_inbox: "Inbox",
    open_notes: "Notes",
...
pub const ZH: Labels = Labels {
    ...
    toggle_session_sidebar: "切换会话侧边栏",
    open_inbox: "收件箱",
    open_notes: "笔记",
...
mod tests {
    ...
    fn translates_every_label() {
        ...
        for (english, chinese) in [
            ...
            (EN.toggle_session_sidebar, toggle_session_sidebar),
